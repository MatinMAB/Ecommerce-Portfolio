  ...
  <footer class="footer">
        ...
        <div class="footer__row">
          <div class="footer__getcall">
            <div class="footer__getcall-info">
              ...
              <span class="gooter__getcall-span">شماره پشتیبانی : 123456789 - 021</span>
            </div>
          </div>
          <div class="footer__info">
            <div class="footer__info-details">
              <svg xmlns="http://www.w3.org/2000/svg" width="110" height="106" viewBox="0 0 158 106">
              ...
              <h4>امکان تحویل اکسپرس</h4>
            </div>
            <div class="footer__info-details">
              <svg xmlns="http://www.w3.org/2000/svg" width="110" height="106" viewBox="0 0 126 120">
                <g fill="none" fill-rule="evenodd">
                  <path
                    fill="#F05562"
                    fill-rule="nonzero"
            ...
            <div class="footer__info-details">
              ...
              <h4>7 روز هفته، 24 ساعته</h4>
            </div>
            <div class="footer__info-details">
              <svg xmlns="http://www.w3.org/2000/svg" width="110" height="106" viewBox="0 0 117 120">
                <g fill="none" fill-rule="evenodd">
              ...
              <h4>7 روز ضمانت بازگشت کالا</h4>
            </div>
            <div class="footer__info-details">
              <svg xmlns="http://www.w3.org/2000/svg" width="110" height="106" viewBox="0 0 101 120">
    ...
    <div class="footer__main">
      ...
      <div class="footer__team">
        طراحی و توسعه سایت فروشگاهی توسط Matin_MAB و
        © 1400
      </div>
    </div>
